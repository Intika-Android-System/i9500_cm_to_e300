...
.method private addTrackerToRawTable(Lcom/android/internal/telephony/InboundSmsTracker;)I
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/InboundSmsHandler;->loge(Ljava/lang/String;)V
    :try_end_bc
    .catchall {:try_start_8 .. :try_end_bc} :catchall_120
    .catch Landroid/database/SQLException; {:try_start_8 .. :try_end_bc} :catch_111
    ...
    invoke-interface {v9}, Landroid/database/Cursor;->close()V
    :try_end_c6
    .catchall {:try_start_c3 .. :try_end_c6} :catchall_120
    .catch Landroid/database/SQLException; {:try_start_c3 .. :try_end_c6} :catch_111
    ...
    :try_end_10f
    .catch Ljava/lang/Exception; {:try_start_f3 .. :try_end_10f} :catch_127
    ...
    :try_end_119
    .catchall {:try_start_112 .. :try_end_119} :catchall_120
...
.method handleNewSms(Landroid/os/AsyncResult;)V
    ...
    :try_end_2b
    .catch Ljava/lang/RuntimeException; {:try_start_20 .. :try_end_2b} :catch_3a
...
.method processMessagePart(Lcom/android/internal/telephony/InboundSmsTracker;)Z
    ...
    .line 673
    .local v28, refNumber:Ljava/lang/String;
    invoke-virtual/range {p1 .. p1}, Lcom/android/internal/telephony/InboundSmsTracker;->getMessageCount()I
    ...
    :try_end_91
    .catchall {:try_start_5f .. :try_end_91} :catchall_f1
    .catch Landroid/database/SQLException; {:try_start_5f .. :try_end_91} :catch_e0
    ...
    .end local v28           #refNumber:Ljava/lang/String;
    :cond_9c
    :goto_9c
    return v3
    ...
    .restart local v28       #refNumber:Ljava/lang/String;
    :cond_9d
    :try_start_9d
    move/from16 v0, v22
    ...
    :try_end_d0
    .catchall {:try_start_9d .. :try_end_d0} :catchall_f1
    .catch Landroid/database/SQLException; {:try_start_9d .. :try_end_d0} :catch_e0
    ...
    :try_end_ea
    .catchall {:try_start_e1 .. :try_end_ea} :catchall_f1
    ...
    .line 742
    .local v29, regAddresses:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    ...
    invoke-static {v0, v3}, Landroid/provider/Telephony$Sms$Intents;->getNormalizedAddressesFromPdus([[BLjava/lang/String;)Ljava/util/List;

    move-result-object v10

    .line 745
    .local v10, allAddresses:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    move-object/from16 v0, v29

    invoke-static {v0, v10}, Ljava/util/Collections;->disjoint(Ljava/util/Collection;Ljava/util/Collection;)Z
    ...
    const-string v3, "android.provider.Telephony.ACTION_PROTECTED_SMS_RECEIVED"
    ...
    .line 749
    const-string v3, "android.permission.RECEIVE_PROTECTED_SMS"
